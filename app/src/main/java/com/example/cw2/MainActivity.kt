...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ingredientSearch: Button = findViewById(R.id.ingredientSearch)
        val addButton: Button= findViewById(R.id.addMeals)
        val mealSearch=findViewById<Button>(R.id.mealSearch)
        val webSearch=findViewById<Button>(R.id.web_search)
        addButton.setOnClickListener{addMeals()}
        //goes to the page which shows the meals which use the relevant ingredient
        ingredientSearch.setOnClickListener{val intent = Intent(this,SearchIngredient::class.java)
        startActivity(intent)}
        //goes to the page where it searches the meals from the database
        mealSearch.setOnClickListener{
            val intent = Intent(this,SearchMeal::class.java)
            startActivity(intent)
        }
        //goes to the web search when clicked on the web search button
        webSearch.setOnClickListener{
            val intent = Intent(this,WebSearch::class.java)
            startActivity(intent)
        }
    }
    //function which adds all the hardcoded meals
    fun addMeals(){
        ...
        runBlocking {
            launch {// run the code of the coroutine in a new thread
                val user = Meals(
                    ...
                    Measure = listOf("200g", "1","Dash","1/2 tsp","1 tsp","10g","10g","30g","10g","Dash"),
                    null,
                    null,
                    null,
                    null
                ...
                val user2 = Meals(2,
                    ...
                    Measure = listOf("1 tbs","300g","4","500g","1","100g","Chopped"),
                    "https:\\/\\/www.bbcgoodfood.com\\/recipes\\/3146682\\/chicken-marengo",
                    null,
                    null,
                    null
                )
                val user3 = Meals(3,"Beef Banh Mi Bowls with Sriracha Mayo, Carrot & Pickled Cucumber",
                    null,
                    "Beef",
                    "Vietnamese",
                    ...
                    null,
                    "",
                    listOf("Rice","Onion","Lime","Garlic Clove","Cucumber","Carrots","Ground Beef","Soy Sauce",""),
                    Measure = listOf("White","1","1","3","1","3 oz","1 lb", "2 oz"),
                    "",
                    null,
                    null,
                    null
                )
                val meal4=Meals(4,"Leblebi Soup",
                    null,
                    "Vegetarian",
                    "Tunisian",
                    ...
                    Measure = listOf("2 tbs","1 medium finely diced","250g","1.5L","1 tsp","5 cloves","1/2 tsp","1 tsp","Pinch","1/2"),
                    "http:\\/\\/allrecipes.co.uk\\/recipe\\/43419\\/leblebi--tunisian-chickpea-soup-.aspx",
                    null,
                    null,
                    null
                )
                mealDao.insertMeals(user, user2, user3, meal4)
